...
export async function createUiContractBoundary(root) {
  ...
  return Object.freeze({
    ...
    projection(messageType, payload, correlationId, idempotencyKey) {
      ...
      const message = createEnvelope({
        plane, messageType, producer: 'ui-bridge', correlationId, schemaVersion: messageType === 'ui.session-status' ? '1.3.0' : messageType === 'ui.transcript-row' ? '1.1.0' : messageType === 'ui.service-status' ? '1.1.0' : '1.0.0',
